...
| ![Boceto inicial](espacio_para_boceto_1) |
|:----------------------------------------:|
...
| ![Captura del proceso 1](espacio_para_captura_1) |
|:------------------------------------------------:|
| **Fase 1: Descripción** |
...
| **ODS relacionado** | **Contribución del proyecto** |
|---------------------|-------------------------------|
| &nbsp; | &nbsp; |
| &nbsp; | &nbsp; |
